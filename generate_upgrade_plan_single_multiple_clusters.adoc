...
* Certifique-se de que o AutoSupport (ASUP) esteja ativado e configurado corretamente, e que todas as seções necessárias estejam incluídas. Para mais informações, consulte link:hhttps://kb.netapp.com/on-prem/ontap/Ontap_OS/OS-KBs/ONTAP_AutoSupport_Resolution_Guide["Guia de Resolução de Problemas do AutoSupport do ONTAP"].
