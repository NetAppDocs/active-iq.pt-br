...
. Selecione *Ações* no widget *Segurança e Defesa contra Ransomware*. image:Security_Image 2 Ransomware attacks.png["Widget Vulnerabilidades de Segurança"]
...
. Selecione a aba *Riscos Exclusivos* e, em seguida, selecione o link na coluna *Ação Corretiva*. image:Corrective Action_Image 2 Ransomware attacks.png["Coluna Ação Corretiva"]
+
