...
| Renovações de suporte | Compatível com todas as plataformas | Compatível com todas as plataformas | Compatível com todas as plataformas 


| Expansão de storage | Compatível apenas com ONTAP | Compatível apenas com ONTAP | Compatível apenas com ONTAP 


| Inventário | Compatível com todas as plataformas | Compatível apenas com ONTAP | Compatível apenas com ONTAP 


| Atualizações | Compatível apenas com ONTAP | Compatível apenas com ONTAP | Compatível apenas com ONTAP 
|===

NOTE: Todas as plataformas significa ONTAP, E-Series, StorageGRID, ONTAP Select e Cloud Volumes ONTAP.
