...
*Percentuais de mitigação de carbono*: Exibe o percentual de mitigação de carbono em cada site/cidade, e os valores de referência apresentados são baseados na sua localização. Você pode ajustar o percentual de mitigação de carbono para sites específicos selecionando o ícone image:edit_icon_1.png["Uma captura de tela que mostra um ícone editável."] localizado ao lado dos valores percentuais, e os números de carbono serão ajustados automaticamente.
