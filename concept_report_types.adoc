...
| Resumo executivo da avaliação de integridade | Fornece informações sobre vários KPIs do Digital Advisor em formato PowerPoint (PPT), com diferentes KPIs descritos em slides diferentes. | Sim | Sim | Não 
...
| Segurança | Fornece uma visão geral abrangente e exportável dos riscos de segurança de storage do ONTAP e das lacunas de conformidade em clusters, SVMs e volumes. | Sim | Não | Não 
