...
.Passos
. No widget *Planejamento*, clique em *Expansão de storage*.
+
...
. Clique em *Enviar* para enviar a solicitação à equipe de armazenamento da NetApp para auxiliar na expansão de storage dos sistemas selecionados.
