...
* Visualize a taxa de redução de dados, o espaço lógico utilizado, o espaço físico utilizado e o total de dados economizados.
...
* link:concept_value_insights.html["Descubra Value Insights"], que fornece informações gerais sobre saúde, economia, estabilidade e segurança do seu sistema ONTAP.
