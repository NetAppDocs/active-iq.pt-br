...
---
= Termos e definições essenciais no o Digital Advisor
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
** *Corrigir:* Corrige os riscos do sistema usando o Active IQ Unified Manager. Selecione este botão para iniciar o Unified Manager e executar as etapas para mitigar os riscos.
...
* *Widget de planejamento:* Exibe informações sobre a expansão de storage, software e hardware que precisam ser renovados.
+
** *Expansão de storage:* Identifica sistemas que ultrapassaram ou estão próximos de atingir 90% da capacidade e sites GRID que ultrapassaram ou estão próximos de atingir 70% da capacidade. Você pode solicitar o aumento da capacidade do seu sistema de storage.
** *Renovação de Suporte:* Fornece informações sobre o software e o hardware que expiraram ou estão perto de expirar nos próximos 6 meses.
...
* *Eficiência de storage:* Identifica a taxa de eficiência de storage e a economia do seu sistema de storage com e sem cópias de snapshot para sistemas AFF, sistemas não-AFF ou ambos.
...
* *Serviços de API:* Permitem extrair dados de interesse e integrá-los diretamente ao fluxo de trabalho da sua empresa.
...
* *Cliente:* Permite que você visualize e gerencie a base instalada do cliente. O Painel do Cliente é o portal central do Digital Advisor.
