...
O Active IQ Digital Advisor está sendo alterado para Digital Advisor e agora está integrado ao BlueXP, o console de gerenciamento unificado da NetApp para ambientes multicloud híbridos. link:https://docs.netapp.com/us-en/active-iq/digital-advisor-integration-with-console.html["Saiba mais"] .
