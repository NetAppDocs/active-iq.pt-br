...
* O fluxo de trabalho de Bem-estar agora inclui o widget Sustentabilidade, que fornece a contagem de ações recomendadas nos níveis de cliente, lista de observação, site e grupo.  Você pode clicar no número de ações para obter uma visão detalhada dessas ações recomendadas no painel de Sustentabilidade. Para saber mais, consultelink:https://docs.netapp.com/us-en/active-iq/learn-about-sustainability.html["Analise a sustentabilidade dos seus sistemas de storage"] .
...
Ao clicar na caixa azul "Resumo do Volume" na tabela SVM, uma janela pop-up exibe informações detalhadas sobre os volumes que estão hospedados ou associados ao número de série ou nó físico específico.
