...
---
= Melhore a pontuação de sustentabilidade do seu sistema de armazenamento com o Digital Advisor.
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
NOTE: Para obter os melhores resultados do painel, você deve habilitar o AutoSupport.  Se o AutoSupport não estiver habilitado, os dados serão baseados nas especificações do produto.  Para obter detalhes de energia em tempo real, você precisa habilitar o Data Infrastructure Insights.  Para obter mais informações sobre como habilitar o Data Infrastructure Insights, consultelink:https://docs.netapp.com/us-en/data-infrastructure-insights/task_getting_started_with_cloud_insights.html["Data Infrastructure Insights"^] .
...
.Console NetApp
--
. Acesse *Sustentabilidade* na categoria *Saúde* disponível na navegação à esquerda do Console.
...
*** Você também pode revisar as ações adiadas a qualquer momento e selecionar *Considerar* para movê-las para a guia *Ações recomendadas*. + image:actions_for_later.png["Uma captura de tela que mostra ações recomendadas com a opção considerar."]
...
--
. Acesse *Sustentabilidade* na categoria *Saúde* disponível na navegação à esquerda do Console.
. Vá para a tabela *Sistemas*.
. Selecione o número de ações na coluna *Ações recomendadas* para o cluster de destino.
+
...
** Se você selecionar *Later*, ela move a ação recomendada selecionada para a guia *ações para mais tarde*. A ação selecionada será adiada por 30 dias. Após 30 dias, essa ação será movida para a guia *ações recomendadas*.
** Você também pode revisar as ações adiadas a qualquer momento e selecionar *Considerar* para movê-las para a guia *Ações recomendadas*.





TIP: Você pode adicionar ou remover os parâmetros ambientais na tabela *Sistemas* usando oimage:add_icon.png["Um ícone de mais para adicionar ou remover os parâmetros"] ícone e pode exportar esta tabela no formato de valores separados por vírgula (.csv) usando oimage:download_icon.png["Um símbolo de download para exportar o parâmetro"] ícone.

--
.Consultor digital
--
. Acesse *Sustentabilidade* disponível na navegação à esquerda do painel do Digital Advisor .
. Vá para a guia *ações recomendadas*.
. Vá para a tabela *Sistemas*.
. Selecione o número de ações na coluna *Ações recomendadas* para o cluster de destino.
+
