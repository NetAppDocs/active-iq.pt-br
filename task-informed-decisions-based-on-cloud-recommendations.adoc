...
---
= Analise a integridade do seu sistema de armazenamento com recomendações de nuvem no Digital Advisor.
:hardbreaks:
:toclevels: 1
:allow-uri-read: 
:toclevels: 1
...
.Passos
. No painel esquerdo, selecione *Cloud Recommendations*.
. Selecione qualquer um dos links no painel *Migração*.
. Selecione *Migrar para a Nuvem* para iniciar o *Console*.
...
.Passos
. No painel esquerdo, selecione *Cloud Recommendations*.
. Selecione qualquer um dos links no painel *Tiering*.
. Selecione *Tier Data* para iniciar o *Console*.
...
.Passos
. No painel esquerdo, selecione *Cloud Recommendations*.
. Selecione qualquer um dos links no painel *Backup & Archive*.
. Selecione *Fazer backup na nuvem* para iniciar o *Console*.
...
.Passos
. No painel esquerdo, selecione *Cloud Recommendations*.
. Selecione qualquer um dos links no painel *Disaster Recovery*.
. Selecione *Replicar para a Nuvem* para iniciar o *Console*.
