...
[role="lead"]
O widget de bem-estar fornece informações detalhadas sobre o seu sistema de storage. Ele apresenta informações sobre diferentes atributos do seu sistema de storage, como desempenho e eficiência, capacidade, configurações, vulnerabilidades de segurança, renovações de suporte e outros.
