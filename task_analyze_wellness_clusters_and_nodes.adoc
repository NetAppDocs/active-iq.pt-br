...
. No nível do cluster ou do nó, selecione *ClusterViewer* ao lado do widget *Configuração*.
. Selecione a aba *Visualização* para ver uma representação gráfica do cluster.
