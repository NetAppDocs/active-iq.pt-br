...
----
+
Para obter mais informações sobre o comando ansible-galaxy, consulte link:https://docs.ansible.com/projects/ansible/latest/cli/ansible-galaxy.html["Documentação do Ansible Galaxy"^] e, para obter mais informações sobre a coleção Ansible da NetApp, consulte link:https://galaxy.ansible.com/netapp/ontap["Página de coleção do NetApp Ansible"^].
